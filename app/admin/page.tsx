...
export default function AdminPage() {
  ...
  return (
    <>
      ...
      {!user ? (
        <LoginForm classId={currentTheme} />
      ) : (
        <div data-class-theme={currentTheme} className="min-h-screen">
          {/* Top bar */}
          <div
            className="sticky top-0 z-50 flex items-center justify-between px-6 py-3 transition-colors duration-200"
            style={{
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-muted-foreground text-sm font-medium">פאנל ניהול</span>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="text-xs text-muted-foreground hover:text-red-500 dark:hover:text-red-400 transition-colors px-3 py-1.5 rounded-full hover:bg-black/5 dark:hover:bg-white/10"
              >
                יציאה
              </button>
            </div>
          ...
          {/* Tab navigation */}
          <div
            className="flex gap-2 px-6 py-3 overflow-x-auto transition-colors duration-200"
            ...
            {TABS.map((tab) => (
              <button
                ...
                className={`text-sm px-4 py-2 rounded-lg whitespace-nowrap transition-all cursor-pointer flex items-center gap-1.5 ${
                  activeTab === tab.id
                    ? "bg-violet-500/15 text-violet-700 dark:bg-violet-600/30 dark:text-violet-300 border border-violet-500/30 dark:border-violet-500/40 font-semibold"
